          ...
          <div style={{ display: 'flex', gap: '0.3rem' }}>
            {editingRecipeId && (
              <>
                ...
                <button type="button" style={{ padding: '0.35rem 0.5rem', fontSize: '0.8rem', background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.3)', color: 'var(--color-fat)', borderRadius: '8px', cursor: 'pointer' }} onClick={() => handleDeleteRecipe(editingRecipeId)}></button>
              </>
            )}
